            ...
            if (me.spanX > 1 || me.spanY > 1) {
                ...
                for (int y = startY; y < mTrgY; y++) {
                    for (int x = 0; x < mTrgX; x++) {
                        ...
                        if (occupied.isRegionVacant(x, y, myW, myH, me.itemType)) {
                        ...
                        if (myW > me.minSpanX && occupied.isRegionVacant(x, y, myW - 1, myH, me.itemType)) {
                            me.spanX--;
                            occupied.markCells(me, true);
                            // 1 extra move cost
                        ...
                        if (myH > me.minSpanY && occupied.isRegionVacant(x, y, myW, myH - 1, me.itemType)) {
                            me.spanY--;
                            occupied.markCells(me, true);
                            // 1 extra move cost
                            find(index + 1, weightLoss, newMoveCost + 1, itemsIncludingMe);
                        ...
                        if (myH > me.minSpanY && myW > me.minSpanX &&
                                occupied.isRegionVacant(x, y, myW - 1, myH - 1, me.itemType)) {
                            me.spanX--;
                            me.spanY--;
                            occupied.markCells(me, true);
                            // 2 extra move cost
